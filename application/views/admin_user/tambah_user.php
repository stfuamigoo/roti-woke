   ...
   <div class="row">
      <div class="col-lg-6">
         ...
         <div class="card shadow mb-4">
            ...
            <div class="card-body">
               <form action="<?php echo site_url(); ?>admin_manage_user/tambah_user" method="post">
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-9">
                        <input type="alamat" class="form-control" id="alamat" name="alamat"><?php echo set_value('alamat'); ?></input>
                  ...
                  <div class="form-group row">
                     ...
                     <div class="col-lg-9">
                        <input type="telepon" class="form-control" id="telepon" name="telepon"><?php echo set_value('telepon'); ?></input>
